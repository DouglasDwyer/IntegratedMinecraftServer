#pragma checksum "D:\Projects\IntegratedMinecraftServer\IMS-Interface\Pages\ServerPreferences.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "079882088eb1fbf636e2c1731111faf14779d165"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 4 "D:\Projects\IntegratedMinecraftServer\IMS-Interface\Pages\ServerPreferences.razor"
using IMS_Library;
...
#nullable restore
#line 13 "D:\Projects\IntegratedMinecraftServer\IMS-Interface\Pages\ServerPreferences.razor"
                                 PreferenceLayout
...
#nullable restore
#line 15 "D:\Projects\IntegratedMinecraftServer\IMS-Interface\Pages\ServerPreferences.razor"
    ...
    static ServerPreferences()
    {
        ...
        Func<List<PreferenceDisplay>> bedrockLayoutGenerator = () =>
        {
            ...
            layout.Add(new MultiToggleDisplay("DefaultPlayerPermissionStatus", "Default player permission level", "This setting determines the default permission status that new players receive.", new[] { "Visitor", "Member", "Operator" }));
            layout.Add(new MultiToggleDisplay("Gamemode", "Gamemode", "This setting determines the default gamemode that new players spawn with.", new[] { "Survival", "Creative", "Adventure", "Spectator" }));
            ...
            layout.Add(new NetworkCompressionThresholdDisplay("NetworkCompressionThreshold", "Network compression threshold", "This setting controls how many bytes a packet must be for the server to compress it."));
            layout.Add(new MultiToggleDisplay("ServerAuthoritativeMovementConfiguration", "Server authoritative movement", "This setting determines whether the server will analyze player movement to prevent cheating.", new[] { "Client", "Server", "Server with rewind" }));
            layout.Add(new ConditionalDisplay(new IntegerDisplay("PlayerMovementScoreThreshold", "Abnormal player movement score threshold", "This setting determines the number of times that abnormal movement of a player can occur before it is reported.", 1, int.MaxValue), config => ((BedrockServerConfiguration)config).ServerAuthoritativeMovementConfiguration == BedrockServerConfiguration.AuthoritativeMovementType.Client));
            layout.Add(new ConditionalDisplay(new DoubleDisplay("PlayerMovementDistanceThreshold", "Abnormal player movement distance threshold", "This setting determines the difference between server and player-calculated positions, in blocks, that must be exceeded before abnormal movement is detected.", 0, double.MaxValue), config => ((BedrockServerConfiguration)config).ServerAuthoritativeMovementConfiguration == BedrockServerConfiguration.AuthoritativeMovementType.Client));
            layout.Add(new ConditionalDisplay(new IntegerDisplay("PlayerMovementDurationThreshold", "Abnormal player movement duration threshold", "This setting determines the amount of time, in milliseconds, that the server and player-calculated positions must be out of sync before abnormal movement is detected.", 1, int.MaxValue), config => ((BedrockServerConfiguration)config).ServerAuthoritativeMovementConfiguration == BedrockServerConfiguration.AuthoritativeMovementType.Client));
            layout.Add(new ConditionalDisplay(new BooleanDisplay("CorrectPlayerMovement", "Player movement correction", "This setting determines whether the server should correct players' position when their movement score exceeds the threshold.", "Enabled", "Disabled"), config => ((BedrockServerConfiguration)config).ServerAuthoritativeMovementConfiguration == BedrockServerConfiguration.AuthoritativeMovementType.Client));
            layout.Add(new BooleanDisplay("ServerAuthoritativeBlockBreaking", "Server authoritative block-breaking", "Whether the server should verify clients' attempts to break blocks.", "Enabled", "Disabled"));
            return layout;
        };
